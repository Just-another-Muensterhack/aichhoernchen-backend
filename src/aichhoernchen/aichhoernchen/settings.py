"""
Django settings for aichhoernchen project.
...
ROOT_URLCONF = 'aichhoernchen.urls'
...
WSGI_APPLICATION = 'aichhoernchen.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        "NAME": os.getenv("POSTGRES_DB", "aichhoernchen"),
    }
}
...
# Azure OpenAI configuration (optional; used by finder.services)
AZURE_OPENAI_ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINT")
AZURE_OPENAI_API_KEY = os.getenv("AZURE_OPENAI_API_KEY")
AZURE_OPENAI_API_VERSION = os.getenv("AZURE_OPENAI_API_VERSION", "2024-02-01")
AZURE_OPENAI_DEPLOYMENT = os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT")
AZURE_OPENAI_IMAGE_ANALYSIS_DEPLOYMENT = os.getenv(
    "AZURE_OPENAI_IMAGE_ANALYSIS_DEPLOYMENT",
